...
unlocked to sign the Nexuscoin-Qt.app bundle.
...
allowing somebody to distribute a Nexuscoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the nexuscoin-qt.exe file inside the installer had not been tampered with.
